...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/learning/{course}/{courseVideoId}',[FrontController::class, 'learning'])->name('front.learning')->middleware('role:student')->middleware('role:student|owner|teacher');
    ...
    Route::prefix('admin')->name('admin.')->group(function (){
        ...
        Route::resource('subscriptions_transaction', SubscribeTransactionController::class)->middleware('role:owner');

        Route::get('/add/video/{course:id}', [CourseVideoController::class, 'create'])->name('courses.add_video')->middleware('role:owner|teacher');
